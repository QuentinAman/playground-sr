...
import { Divider, Slot, InputList, MultiSelectMenu } from '../../molecules';
...
export const CompanyArea = ({ ...props }) => {
    ...
    return (
        <div className={`w-full rounded bg-white px-8 py-6 grid gap-6`}>
            <div className="flex justify-between">
                <InputFile
                    caution="GIF, JPG, PNG sont autorisés. Max hauteur 100px."
                    color="white"
            ...
            <div className="grid grid-cols-3 gap-x-20 gap-y-6 font-semibold">
                <Divider bottom className="whitespace-nowrap">
                    Vous êtes...
                </Divider>
                <Divider bottom className="col-span-2 whitespace-nowrap">
                    Votre entreprise
                </Divider>
                ...
                <div className="grid gap-4">
                    ...
                    <Textarea
                        onInput={setCompanyInfo}
                        value={companyInfo}
                        max={1500}
                        required
                        placeholder="Texte informatif sur votre entreprise."
                        height="h-64"
                    ></Textarea>
                    <MultiSelectMenu
                        className="pr-1"
                ...
                <div className="grid gap-10">
                    <div className="grid gap-1">
                        ...
                        <p className="text-xs font-light mb-1">
                            Youtube, vimeo vidéos sont autorisés
                        </p>
                        <InputList
                            type="ListElement"
                    ...
                    <div className="grid gap-1">
                        ...
                        <p className="text-xs font-light mb-1">
                            Seulement les PDF sont autorisés.
                        </p>
                        <ListElement
                            content={{
